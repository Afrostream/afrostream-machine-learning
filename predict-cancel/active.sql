...
, case when M1.title is not null then 'E'||"Episodes"."episodeNumber" else '' end as ep
...
INNER JOIN (
	...
	-- on ne veut que des active
	AND
	(  -- active
	    (BS.sub_expires_date is null AND BS.sub_canceled_date is null)
        )
